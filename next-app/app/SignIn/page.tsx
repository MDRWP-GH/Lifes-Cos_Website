...
// โหลดเฉพาะ motion.div และ motion.button
...
export default function SignInPage() {
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row w-full max-w-6xl shadow-2xl rounded-2xl overflow-hidden bg-white/10 backdrop-blur-md border border-white/20">
        {/* รูปด้านซ้าย */}
        <MotionDiv
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1 }}
          className="hidden md:flex md:w-1/2 items-center justify-center p-6 bg-black/30"
        >
          <Image
            src="/images/Lifes'Cos-4912.JPG"
            alt="Login Image"
            width={500}
            height={500}
